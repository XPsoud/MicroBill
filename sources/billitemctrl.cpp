...
BillItemCtrl::~BillItemCtrl()
{
#ifdef __WXDEBUG__
    wxPrintf(_T("Destroying a \"BillItemCtrl\" object\n"));
#endif // __WXDEBUG__
}

void BillItemCtrl::SetDatas(const wxString& descr, const wxString& comm, double unitPrice, int quantity)
{
    m_sDescr=descr;
    m_sComments=comm;
...
void BillItemCtrl::CreateControls()
{
...
void BillItemCtrl::ConnectControls()
{
    m_lblDescr->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    m_lblComments->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    m_lblPrice->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);

    Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
    ...
    for (int i=0; i<iCount; ++i)
    {
        ...
        if (sitm->IsWindow())
        {
            sitm->GetWindow()->Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
            sitm->GetWindow()->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
        }
    }
    m_btnEdit->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    m_btnDelete->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    m_btnMoveUp->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);
    m_btnMoveDown->Bind(wxEVT_ENTER_WINDOW, &BillItemCtrl::OnMouseEnter, this);

    m_btnEdit->Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
    m_btnDelete->Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
    m_btnMoveUp->Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
    m_btnMoveDown->Bind(wxEVT_LEAVE_WINDOW, &BillItemCtrl::OnMouseLeave, this);
}

void BillItemCtrl::Update()
{
...
void BillItemCtrl::OnMouseEnter(wxMouseEvent& event)
{
...
void BillItemCtrl::OnMouseLeave(wxMouseEvent& event)
{
    wxPoint pt;
