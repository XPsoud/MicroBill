...
DlgAddEditBillItem::DlgAddEditBillItem(wxWindow *parent) : wxDialog(parent, -1, _("New bill entry"))
{
#ifdef __WXDEBUG__
    wxPrintf(_T("Creating a \"DlgAddEditBillItem\" object\n"));
#endif // __WXDEBUG__
...
DlgAddEditBillItem::~DlgAddEditBillItem()
{
#ifdef __WXDEBUG__
    wxPrintf(_T("Destroying a \"DlgAddEditBillItem\" object\n"));
#endif // __WXDEBUG__
}

void DlgAddEditBillItem::CreateControls()
{
...
void DlgAddEditBillItem::ConnectControls()
{
    Bind(wxEVT_BUTTON, &DlgAddEditBillItem::OnBtnValidClicked, this, wxID_OK);
    Bind(wxEVT_UPDATE_UI, &DlgAddEditBillItem::OnUpdateUI_BtnValid, this, wxID_OK);
}

void DlgAddEditBillItem::OnUpdateUI_BtnValid(wxUpdateUIEvent& event)
{
    event.Enable(!m_txtDescr->IsEmpty());
}

void DlgAddEditBillItem::OnBtnValidClicked(wxCommandEvent& event)
{
    EndModal(wxID_OK);
}

void DlgAddEditBillItem::SetItemDatas(const wxString& descr, const wxString& comments, double unitPrice, int quantity)
{
    SetTitle(_("Edit a bill entry"));
